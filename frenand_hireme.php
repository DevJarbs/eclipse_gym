...
<body>
    <div class="header">
    <h1 class="text-center mb-3">YOU'RE ABOUT TO HIRE FRENAND</h1>
    ...
    <form id="bookingForm">
        <label for="trainer" class="d-flex justify-content-center">
          <input type="text" id="trainerDisplay" class="form-control text-center fs-5 bg-primary" value="Frenand" disabled>
          <input type="hidden" name="trainer" id="trainer" value="Frenand">
        </label>
            ...
            <input type="number" class="form-control" id="ratePerSession" name="rate_per_session" value="150" placeholder="Rate per session" readonly>
    ...
    <script src="JS/hirefrenand.js"></script>
